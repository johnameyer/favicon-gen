/**
 * Hardcoded placeholder emoji SVG (Noto "grinning face", U+1F600), sourced
 * from https://github.com/googlefonts/noto-emoji/blob/main/svg/emoji_u1f600.svg
 *
 * This is a temporary, in-code stand-in for step 2's dynamic CDN fetching of
 * emoji SVGs. Keeping it as a TS constant (rather than a static asset) keeps
 * this step self-contained and makes it trivial to delete once emoji
 * fetching lands.
 */
export const EMOJI_PLACEHOLDER_SVG = `<?xml version="1.0" encoding="utf-8"?>
